(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://texdeck.net/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://texdeck.net/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://texdeck.net/assets/css/just-the-docs-' + theme + ".css"
      );
    };
